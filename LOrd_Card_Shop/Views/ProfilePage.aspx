<%@ Page Async="true" Title="" Language="C#" MasterPageFile="~/Master/Navbar.Master" AutoEventWireup="true" CodeBehind="ProfilePage.aspx.cs" Inherits="LOrd_Card_Shop.Views.ProfilePage" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <asp:Label ID="pwLbl" runat="server" Text="Old Password"></asp:Label><br />
